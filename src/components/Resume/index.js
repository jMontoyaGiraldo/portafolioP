        ...
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <h3 class="flex items-center mb-1 text-lg font-semibold  text-white ml-28">
              Henry Full Stack Development
            </h3>
            <time class="block pt-1 pb-3  text-sm font-normal leading-none  text-gray-500">
             in progress, 2023
            </time>
            <p class="mb-4 text-base font-normal  text-gray-400">
            study program of the most popular and useful technologies for the current needs of the market,
             together with the best possible practices given by ES6 and different work samples, 
             together with projects for the implementation of the acquired knowledge
            </p>
            {/* <a
          ...
          <li class="mb-10" data-aos="zoom-in">
            ...
            <p class="mb-4 text-base font-normal  text-gray-400">
            study program for the understanding of the most important concepts of computer science and the basic foundations
             of programming in terms of logic with the use of pseudocode for the understanding of data flows and algorithms
            </p>
            {/* <a
              href="https://www.credly.com/badges/bf6b9024-d4f8-465d-b345-d9b0c5a7abab/public_url"
              target="_blank"
