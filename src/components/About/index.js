      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Juan Manuel,</span> a Web
            Enthusiast
          </h3>
          <p
            ...
            data-aos={"fade-left"}
          >
            I love the sports, reading books of scientific dissemination and video games. I am fond of technology from different fields
             and happy to learn more and more about all these. I am {getDate()}{" "}
        ...
        >
          ...
          <button className="py-3 mt-5 text-white mx-auto px-9 bg-blue-600 border-2 w-fit border-blue-500 rounded-3xl  hover:-translate-y-1.5 duration-[350ms] hover:duration-[350ms] hover:bg-blue-800 hover:scale-[1.023] focus:bg-blue-800 animate-zoomy">
            <a
              href={require("../../assets/files/JuanManuelMontoyaGiraldoCreativeCV - copia.pdf")}
              download={"juan'sResume.pdf"}
            >
              Download CV
              <DownloadIcon />
            </a>
